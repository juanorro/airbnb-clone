  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Rental Apartments Website" />
      ...
      <div className="pt-6">
        <div className="mt-6 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
          ...
          <div className="hidden lg:grid lg:grid-cols-1 lg:grap-y-8">
            ...
            <div className="aspect-w-3 aspect-h-2 rounded-lg overflow-hidden mt-5">
              <img 
                src="/img/4.jpg"
                className="w-full h-full object-center object-cover"
              />
      ...
      <div className="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto, auto, 1fr] lg:gap-x8">
      ...
      <div className="relative py-16 sm:py-24 lg:py-32">
        <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
          ...
          <p className="mt-5 max-2-prose mx-auto text-xl text-gray-300">
