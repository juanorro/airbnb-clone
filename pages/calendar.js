...
import { addDayToRange, calcNumberOfNightsBetweenDates, getBlockedDates, getDatesBetweenDates, isDaySelectable } from 'lib/dates';
      ...
      <div className='relative overflow-hidden'>
              ...
              <div className='relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8 bg-gray-800/80'>
                ...
                <div className='mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center'>
                  <div className='space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-1 sm:gap-5'>
                    <Link href={ '/' }>
                      <a className='flex items-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-blue-50 sm:px-8'>
        ...
        <div className='flex flex-col mt-10'>
          ...
          <p className='text-center'>
            { numberOfNights > 0 && (
                <button
                  className='bg-green-500 text-white mt-5 mx-auto w-40 px-4 py-3 border border-transparent
                  ...
                  onClick={ async() => {
                    ...
                    console.log('stripePublic => ', stripePublicKey);
